...
public class CreatePage extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void createAccount(View view) {
        ...
        Database database = new Database(CreatePage.this);
        ...
        if(!strPassword.equals(strPasswordRepeat)){
        ...
        else if(database.checkUsername(strUsername)){
            ...
            if(strAccountType.equals("Member")){
                try{
                    ...
                    success = database.createAccount(account);
            ...
            if(success){
                Toast.makeText(getApplicationContext(), "Success: " + strUsername + " " + strPassword + " " + strPasswordRepeat + " " + strFirstName + " " + strLastName + " " + strAccountType, Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    }
